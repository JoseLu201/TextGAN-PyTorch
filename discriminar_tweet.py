...
def main_discriminar_tweet(load_model_path, dis_model, tweets):
    ...
    model_path = os.path.join(load_model_path, 'models', dis_model)
    ...
    try:
        ...
        print("Errror en la carga del diccionario")
    ...
    try:
        ...
        print(e)
        raise Exception("Error en la tokenizacion ES POSIBLE QUE LAS PALABRAS NO ESTEN EN EL DICCIONARIO", e)
